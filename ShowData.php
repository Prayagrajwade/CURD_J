                            ...
                            if ($result->num_rows > 0) {
                              $a = 1;
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>" . $row["salary"] . "</td>";
                                    echo "<td>" . $row["job_role"] . "</td>";
                                    #$_SESSION["id"] = $row["customer_id"];  # ?id=" . $row["customer_id"] . href='process_deleteData.php' "'
                                    ...
                                    echo "<td><a href='Process_Update.php' id = 'UpdateForm' class='btn btn-success'><i class='bi bi-pen'>Update</i></a></td>";
                                    echo "</tr>";
                                    $a++;
                                }
                            } else {
